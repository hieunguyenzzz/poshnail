    ...
    <div className="bg-base-100">
      <Container>
            ...
            <div className="items-end justify-start h-96 hero bg-primary rounded-box">
              <div className="hero-content">
                <div className="py-6 hero-text">
                  <div className="py-2 font-bold text-9xl text-primary-content">
                    Aa
                  </div>{' '}
                  ...
                  <p className="text-primary-content">
                    Omnis quo eveniet veniam quis odit.
                  </p>
                </div>
              </div>
            </div>{' '}
        ...
        <div className="grid grid-cols-1 gap-6 lg:p-10 xl:grid-cols-3 lg:bg-base-200 rounded-box">
          ...
          <ul className="menu row-span-3 p-4 shadow-lg bg-base-100 rounded-box">
